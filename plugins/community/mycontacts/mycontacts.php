	...
	class plgCommunityMyContacts extends CApplications
	{
		...
		public function renderSetting(){
			...
			foreach($enable->personalInfo as $key=>$value){
				if($value){
					$html[] = '<tr>';
					$html[] = '<td class="key"><span class="editlinktip hasTip" title="'.JText::_( strtoupper('mycontact_'.$key)).'">'. JText::_( strtoupper('mycontact_'.$key)) .'</span></td>';
					$html[] = '<td class="field" valign="top">'. '<input title="'.JText::_( strtoupper('mycontact_'.$key)).'" id=params'.$key.' class="text_area" type="text" value="'.$info->personal->$key.'" name=params['.$key.']>' .'</td>';
					$html[] = '</tr>';
				}
			}
			...
			foreach($enable->workInfo as $key=>$value){
				if($value){
					$html[] = '<tr>';
					$html[] = '<td class="key"><span class="editlinktip hasTip" title="'.JText::_( strtoupper('mycontact_'.$key)).'">'. JText::_( strtoupper('mycontact_'.$key)) .'</span></td>';
					$html[] = '<td class="field" valign="top">'. '<input title="'.JText::_( strtoupper('mycontact_'.$key)).'" id=params'.$key.' class="text_area" type="text" value="'.$info->work->$key.'" name=params['.$key.']>' .'</td>';
					$html[] = '</tr>';
				}
			}
			...
			if($enable->im_list){
				foreach($info->im as $key=>$value){
					$html[] = '<tr>';
					$html[] = '<td class="key"><span class="editlinktip hasTip" title="'.JText::_( strtoupper('mycontacts_'.$key)).'">'. JText::_( strtoupper('mycontacts_'.$key)) .'</span></td>';
					$html[] = '<td class="field" valign="top">'. '<input title="'.JText::_( strtoupper('mycontacts_'.$key)).'" id=params'.$key.' class="text_area" type="text" value="'.$info->im->$key.'" name=params['.$key.']>' .'</td>';
					$html[] = '</tr>';
				}
			}
