...
if($user->id == 0)
{
	JError::raiseWarning( 403, JText::_( 'COM_TGTRECIPES_ERROR_MUST_LOGIN') );
	$joomlaLoginUrl = 'index.php?option=com_users&view=login';

	echo "<br><a href='".JRoute::_($joomlaLoginUrl)."'>".JText::_( 'COM_TGTRECIPES_LOG_IN')."</a><br>";
}
else
{
		...
		<?php endif;?>
			...
			<table class="table table-striped" id="tgtrecipeList">
				...
				<?php foreach ($this->items as $i => $item) :
					...
					$canChange  = $user->authorise('core.edit.state', 'com_tgtrecipes') && $canCheckin;
					$canEdit    = $user->authorise('core.edit',       'com_tgtrecipes.category.' . $item->catid);
					?>
