...
// Respect "newtab" setting.
$anchorAttr = '';
if ( $newtab = $config->get('newtab') ) {
  $anchorAttr = ' href="' . CRoute::_( $param->get('data')->video_url ) . '" target="_blank"';
} else {
  $anchorAttr = ' href="javascript:joms.walls.showVideoWindow(\'' . $video->id . '\');"';
}
...
<div class="joms-stream-content">
	<span><?php echo JText::sprintf('COM_COMMUNITY_VIDEOS_IS_FEATURED','<a' . $anchorAttr . ' class="cStream-Title">' . $this->escape($video->title) . '</a>'); ?></span>
	<p class="joms-share-meta date"><?php echo $createdTime; ?></p>
	<div class="joms-stream-box joms-fetch-wrapper clearfix">
		<div class="row-fluid">
			<div class="span4">
				<a<?php echo $anchorAttr ?> class="cVideo-Thumb cFloat-L">
			...
			<div class="span8">
				...
				<a<?php echo $anchorAttr; ?>><?php echo $video->title; ?></a>
