...
class CTableVideo extends JTable  implements CTaggable_Item
{
	...
	public function getPlayerHTML($width=null, $height=null, $defaultView=true)
	{
		...
		if ($defaultView)
		{
            $html = (method_exists($this->_provider,'getViewHTML')) ? $this->_provider->getViewHTML($id, $width , $height ) : '';
		} else {
            $html = (method_exists($this->_provider,'getEmbedCode')) ? $this->_provider->getEmbedCode($id, $width , $height ) : '';
		}
