...
class CCategoryHelper
{
	...
	static public function getSelectList( $app, $options, $catid=null, $required=false, $update=false, $firstOption = null)
	{
		$attr	=   '';
        ...
        if($firstOption){
            $first = array(
                0=>array(
                    "id"=> "",
                    "parent"=>0,
                    "name"=> JText::_($firstOption),
                    "description"=>JText::_($firstOption),
                    "published" => 1,
                    "nodeText"=>JText::_($firstOption),
