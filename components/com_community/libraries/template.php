...
if (!class_exists('CTemplate')) {
    ...
    class CTemplate {
        ...
        /**
         *
         * @var The name is intentionally long to avoid collision
         */
        ...
        /**
         * Get template physical file path
         * @param type $file
         * @return string
         */
        ...
        /**
         * Open, parse, and return the template content.
         *
        ...
        public function fetch($file = null) {
            ...
            /* Get physical path file */
            $tplFile = $this->_getTemplateFile($file);
        ...
        public static function addStylesheet($file) {
            if (!strpos($file, 'green')) {
                $assetsFile = CFactory::getPath('template://css/' . $file . '.css');
                if ($assetsFile) {
