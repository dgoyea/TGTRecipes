...
class CFieldsDate extends CProfileField {
    ...
    public function getFieldHTML($field, $required) {
        ...
        $jFormat = str_replace("Y","yy",$this->params->get('date_format', "Y-m-d"));
        $jFormat = str_replace("F","MM",$jFormat);
        $jFormat = str_replace("m","mm",$jFormat);
        $jFormat = str_replace("n","m",$jFormat);
        $jFormat = str_replace("d","dd",$jFormat);
        $jFormat = str_replace("j","d",$jFormat);

        $html .= "changeMonth: true,\n";
        $html .= "changeYear: true,\n";
        $html .= "dateFormat: '".$jFormat."',\n";
