 ...
 * @since       1.6
 */
class JFormFieldGbmedia extends JFormField
{
	/**
	 * The form field type.
	 *
	...
	protected function getInput()
	{
		if (JVERSION>=3.0) {
			...
			$attr .= !empty($this->class) ? ' class="input-width ' . $this->class . '"' : ' class="input-width"';
			...
			if ($showPreview)
			{
				...
				//alter Pfad
				elseif ($this->value && file_exists(JPATH_ROOT . '/images/garyscookbook/' . $this->value)) {
					$this->value = 'images/garyscookbook/' . $this->value;
					$src = JUri::root() . $this->value;
				}
				//kein Bild
				else
				{
					$src = '';
					$src = JURI::base() ."components/com_garyscookbook/assets/images/nopicture.jpg";
					//$this->value = "components/com_garyscookbook/assets/images/nopicture.jpg";
					$picwidth = 100;
				}
				//die;
