 ...
 * @since		1.6
 */
class JFormFieldGcbcategoryEdit extends JFormFieldList
{
	/**
	...
	protected function getOptions()
	{
		...
		//$statopt = array(value=>"0",text=>"Bitte auswählen",level=>"0",published=>"1");
		$statopt = new stdClass();
		$statopt->value = "0";
		$statopt->text =  JText::_('COM_GARYSCOOKBOOK_SELECT_CATAGORY');
		$statopt->level= "0";
		$statopt->published = "1";
