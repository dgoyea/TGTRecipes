...
class GCBInputFilter {
	...
	/**
	  ...
	  */
	public function gcbInputFilter($tagsArray = array(), $attrArray = array(), $tagsMethod = 0, $attrMethod = 0, $xssAuto = 1) {
	 ...
	 * 		<pre>  $filter = & gcbInputFilter::getInstance();</pre>
	 *
	 * @static
	 * @param	array	$tagsArray	list of user-defined tags
	 * @param	array	$attrArray	list of user-defined attributes
	...
	public static function getInstance($tagsArray = array(), $attrArray = array(), $tagsMethod = 0, $attrMethod = 0, $xssAuto = 1) {
		...
		if (empty ($instances[$sig])) {
			$instances[$sig] = new gcbInputFilter($tagsArray, $attrArray, $tagsMethod, $attrMethod, $xssAuto);
		}
	...
	function filterAttr($attrSet)
	{
		...
		for ($i = 0; $i < count($attrSet); $i ++)
		{
			 ...
			 */
			if (gcbInputFilter::badAttributeValue($attrSubSet))
			{
				continue;
			}
