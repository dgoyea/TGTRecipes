					...
					<li>
						<a href="<?php echo JRoute::_('index.php?option=com_community&view=groups&status=0')?>">
							<div class="clearfix">
								...
								<span class="pull-right orange count-pending-groups"><?php echo $this->pendingGroup; ?></span>
							</div>
						</a>
					</li>
					<?php }?>
					...
					<li>
						<a href="<?php echo JRoute::_('index.php?option=com_community&view=events&status=0')?>">
							<div class="clearfix">
								...
								<span class="pull-right orange count-pending-events"><?php echo $this->pendingEvent; ?></span>
							</div>
						</a>
					</li>
					<?php }?>
					...
					<li>
						<a href="<?php echo JRoute::_('index.php?option=com_community&view=users&usertype=jomsocial&status=1&usesearch=0'); ?>">
							<div class="clearfix">
								...
								<span class="pull-right orange count-pending-users"><?php echo $this->pendingUser;?></span>
							</div>
						</a>
					</li>
					<?php }?>
					...
					<li>
						<a href="<?php echo JRoute::_('index.php?option=com_community&view=reports&status=0'); ?>">
							<div class="clearfix">
								...
								<span class="pull-right orange count-reports"><?php echo $this->reportCount; ?></span>
							</div>
						</a>
					</li>
					<?php }?>
					...
					<li>
						<a href="<?php echo JRoute::_('index.php?option=com_community&view=mailqueue&status=0')?>">
							<div class="clearfix">
								...
								<span class="pull-right red count-unsent-mail"><?php echo $this->unsendCount; ?></span>
							</div>
						</a>
					</li>
					<?php }?>
					...
					<li>
						<a href="<?php echo (empty($this->versionUrl)) ? '#' : $this->versionUrl; ?>">
							<div class="clearfix">
								...
								<span class="pull-right green newest-version"><?php echo $this->version ?></span>
							</div>
						</a>
					</li>
					<?php }?>
