		...
		<div class="widget-main">
			...
			<table>
				<tbody>
                    ...
                    <tr>
                        <td class="key">
							<span class="js-tooltip" title="<?php echo JText::_('COM_COMMUNITY_CONFIGURATION_LIMITS_FLOODLIMIT_TIPS'); ?>">
								<?php echo JText::_( 'COM_COMMUNITY_CONFIGURATION_LIMITS_FLOODLIMIT' ); ?>
							</span>
                        </td>
                        <td>
                            <input type="text" name="floodLimit" value="<?php echo $this->config->get('floodLimit');?>" class="input-small" /> <?php echo JText::_('COM_COMMUNITY_SECONDS');?>
                        </td>
                    </tr>
				</tbody>
			</table>
